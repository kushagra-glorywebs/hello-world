										...
										<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable" style="display: block;">
											<thead class="datatable-head"> 
												<tr class="datatable-row" style="left: 0px;">
													<th data-field="Service ID" class="datatable-cell datatable-cell-sort datatble-cell-sorted" data-sort="desc">
                                                        <span style="width: 145px;">
                                                            Service ID
                                                            <i class="flaticon2-arrow-down"></i>
                                                        </span>
                                                    </th>
                                                    <th data-field="Service Name" class="datatable-cell datatable-cell-sort datatble-cell-sorted" data-sort="desc">
                                                        <span style="width: 145px;">
                                                            Service Name
                                                            <i class="flaticon2-arrow-down"></i>
                                                        </span>
                                                    </th>
                                                    <th data-field="Service Status" class="datatable-cell datatable-cell-sort datatble-cell-sorted" data-sort="desc">
                                                        <span style="width: 145px;">
                                                            Service Status
                                                            <i class="flaticon2-arrow-down"></i>
                                                        </span>
											...
											<tbody style class="datatable-body">
												<tr data-row="0" class="datatable-row" style="left: 0px;">
													<td class="datatable-cell-sorted datatabel-cell" data-field="Service ID" arial-lable="3541">
                                                        <span style="width: 145px;">36541</span>
                                                    </td>
													<td class="datatable-cell-sorted datatabel-cell" data-field="Service ID" arial-lable="3541">
                                                        <span style="width: 145px;">Land Rover</span>
                                                    </td>
													<td>Range Rover</td>
													<td>Orange</td>
													<td>$22672.60</td>
